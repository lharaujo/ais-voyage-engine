...
def load_data(con):
    ...
    try:
        ...
        con.execute(f"CREATE OR REPLACE VIEW voyages AS SELECT * FROM read_parquet('{gold_pattern}')")
...
def main():
    ...
    vessel_type = st.sidebar.multiselect("Vessel Type", ["Cargo", "Tanker", "Fishing", "Passenger"], default=["Cargo", "Tanker"])
